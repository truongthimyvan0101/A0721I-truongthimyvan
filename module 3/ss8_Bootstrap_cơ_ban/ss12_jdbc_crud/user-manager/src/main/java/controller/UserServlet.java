...
public class UserServlet extends HttpServlet {
    ...
    private void insertUser(HttpServletRequest request, HttpServletResponse response)
        ...
        String gia_tien = request.getParameter("gia_tien");
        String ngay_bat_dau = request.getParameter("ngay_bat_dau");
        String ngay_ket_thuc = request.getParameter("ngay_ket_thuc");

        User newUser = new User(dien_tich, trang_thai, tang, loai_van_phong, gia_tien, ngay_bat_dau, ngay_ket_thuc);
        RequestDispatcher dispatcher = request.getRequestDispatcher("user/create.jsp");
        dispatcher.forward(request, response);
    }
    ...
    private void updateUser(HttpServletRequest request, HttpServletResponse response)
        ...
        User book = new User(id, dien_tich,trang_thai, tang, loai_van_phong, gia_tien, ngay_bat_dau, ngay_ket_thuc);
